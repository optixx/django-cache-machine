...
CACHE_FLUSHLIST_TTL = getattr(settings, 'CACHE_FLUSHLIST_TTL', DEFAULT_TIMEOUT)
CACHE_FLUSHLIST_ENABLE = getattr(settings, 'CACHE_FLUSHLIST_ENABLE', False)

if CACHE_FLUSHLIST_ENABLE:
    FLUSHLIST_TTL = CACHE_FLUSHLIST_TTL
    if FLUSHLIST_TTL is DEFAULT_TIMEOUT:
